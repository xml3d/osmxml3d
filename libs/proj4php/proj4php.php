...
*/
	protected function initDefs()
	{
		...
		self::$defs['EPSG:3785'] = "+title= Google Mercator +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs";
		self::$defs['GOOGLE'] = self::$defs['EPSG:3785'];
		self::$defs['EPSG:900913'] = self::$defs['EPSG:3785'];
		self::$defs['EPSG:102113'] = self::$defs['EPSG:3785'];
		self::$defs['EPSG:31466'] = "+proj=tmerc +lat_0=0 +lon_0=6 +k=1 +x_0=2500000 +y_0=0 +ellps=bessel +datum=potsdam +units=m +no_defs";
		//self::$defs['EPSG:31466'] = "+proj=tmerc +lat_0=0 +lon_0=6 +k=1 +x_0=2500000 +y_0=0 +ellps=bessel +towgs84=598.1,73.7,418.2,0.202,0.045,-2.455,6.7 +units=m +no_defs";
	}
	...
	protected function initDatum()
	{
		...
		self::$datum["potsdam"] =  array('towgs84'=> "598.1,73.7,418.2,0.202,0.045,-2.455,6.70", 'ellipse'=> "bessel", 'datumName'=> "Potsdam Rauenberg 1950 DHDN");
		//self::$datum["potsdam"] =  array('towgs84'=> "606.0,23.0,413.0", 'ellipse'=> "bessel", 'datumName'=> "Potsdam Rauenberg 1950 DHDN");
		//598.1,73.7,418.2,0.202,0.045,-2.455,6.70" "Germany (Whole Country)" "Accuracy 3m"
